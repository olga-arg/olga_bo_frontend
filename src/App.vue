      ...
      <div class="p-24">
        <div class="flex mb-4">
          <div class="flex items-center h-24 rounded">
            <div className="pr-10 font-medium text-[#1C2E3D] text-xl">
              <p>Miembros</p>
        ...
        <div class="flex items-center justify-between h-20 mb-4">
          <button className="bg-[rgb(248,247,250)] border-[#DBDADF] border p-1 rounded-md px-6 text-[#8D8B96]">Añadir Miembro</button>
          <form>
