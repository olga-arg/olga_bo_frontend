  ...
  <div class="grid grid-cols-2">
    <section class="bg-gray-50 dark:bg-gray-900">
      <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="h-16 mr-2" src="@/assets/rendilo_i.png" alt="logo" />
        </a>

        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">Bienvenido :)</h1>
            <a v-if="userState === 'OTP' && this.loading === false" class="text-xs leading-tight tracking-tight text-gray-900 md:text-sm dark:text-white"
              >Ingresa el código de acceso que enviamos a tu mail.</a
            >
            <a v-else class="text-xs leading-tight tracking-tight text-gray-900 md:text-sm dark:text-white">Ingresa tu mail para obtener un código de acceso.</a>
    ...
    <section class="relative text-center bg-[#DE848B]">
      ...
      <div class="absolute bottom-20 left-24 text-left">
        <a class="text-4xl text-white font-regular"
          >Simplifica la rendición de gastos.<br />
          Amplifica tus fondos.</a
        >
        <br />
        <br />
        <a class="text-xl font-light text-white"
          >Toma el control del proceso de rendición de gastos,<br />
          de forma más rápida y sencilla.</a
        >
      </div>
    </section>
  </div>
