          ...
          <div class="flex-col p-5">
            ...
            <div v-for="user in team?.users" class="flex justify-between items-center pt-2">
              ...
              <div class="flex items-center p-1">
                <button v-if="!team.reviewer || user.id !== team.reviewer.id" class="mr-5 text-red-600 font-bold" v-on:click="removeFromTeam(team, user)">X</button>
                <div v-if="team.reviewer && user.id === team.reviewer.id">
